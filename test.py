...
# for key, value in compass_english2chinese.items():
#     if value not in compass_list_all:
#         print(f"P{key}:{value}")

for each in compass_list_all:
    if each not in compass_english2chinese.values():
        print(each)